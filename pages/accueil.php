...
<body>
    ...
    <div class="htext">
BIENVENU SUR LE SITE DE UFR SDS DE L'UNIVERSITE JOSEPH KI-ZERBO
    </div>
    <hr class="hbr">
    <div class="container-fluid">
        <div class="row">
                    ...
                    <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
                        <div class="carousel-inner">
                          <div class="carousel-item active">
                            <img src="../images/carrous/african-student-female-posed-with-backpack-and-school-items-on-yard-of-university-against-flags-of-different-countries.jpg" class="d-block w-100" alt="...">
                          </div>
                          <div class="carousel-item">
                            <img src="../images/carrous/group-of-male-african-medical-students-in-college.jpg" class="d-block w-100" alt="...">
                          </div>
                          <div class="carousel-item">
                            <img src="../images/carrous/young-african-students-wearing-facemasks-and-holding-books-and-phones-at-campus.jpg" class="d-block w-100" alt="...">
                          </div>
                        </div>
                      ...
                      <div class="go3">Des Etudiants disciplinés et travailleurs</div>
                </div>
            </section>
